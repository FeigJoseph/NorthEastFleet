...
const Hero = () => {
  return (
    <div className="relative bg-slate-900 min-h-screen flex items-center">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-2xl">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Serving the tri-state area for over 25 years with quality workmanship and dedicated service.
          </p>
