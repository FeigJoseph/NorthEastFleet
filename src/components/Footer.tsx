        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <p className="mb-4 text-slate-300">
              Your trusted partner in fleet maintenance and repair services for over 25 years.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <a href="tel:+16095551234" className="text-slate-300 hover:text-orange-400 transition-colors">(609) 555-1234</a>
              </li>
              <li className="flex items-center">
                <Mail className="h-5 w-5 mr-2 text-orange-400" />
                <a href="mailto:info@northeastfleet.com" className="text-slate-300 hover:text-orange-400 transition-colors">info@northeastfleet.com</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="#top" className="text-slate-300 hover:text-orange-400 transition-colors">
                  Home
                </Link>
              </li>
              <li>
                <Link to="#services" className="text-slate-300 hover:text-orange-400 transition-colors">
                  Services
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="#gallery" className="text-slate-300 hover:text-orange-400 transition-colors">
                  Gallery
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-slate-700 pt-8">
          <div className="flex flex-col md:flex-row md:justify-between items-center">
            <p className="text-slate-400 mb-4 md:mb-0">
              &copy; {currentYear} North East Fleet Service. All rights reserved.
            </p>
